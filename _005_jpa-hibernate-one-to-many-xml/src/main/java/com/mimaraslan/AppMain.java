...
public class AppMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Create customer
            Customer customer1 = new Customer("Mr.", "Mimar Aslan");

            // Create orders
            Orders order1 = new Orders("code1", Float.parseFloat("111.11"), new Date());
            Orders order2 = new Orders("code2", Float.parseFloat("222.22"), new Date());
            Orders order3 = new Orders("code3", Float.parseFloat("333.33"), new Date());
...
//-------------------------------------------------------------				
            ...
            Orders order4 = new Orders("code4", Float.parseFloat("444.44"), new Date());
            Orders order5 = new Orders("code5", Float.parseFloat("555.55"), new Date());
            Orders order6 = new Orders("code6", Float.parseFloat("666.66"), new Date());
