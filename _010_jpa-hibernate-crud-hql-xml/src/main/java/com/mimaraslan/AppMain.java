...
public class AppMain {
	...
	public static void create() {
		...
		try {
			...
			Product product1 = new Product("Book", 1, 15.45F, false, new Date());
			Product product2 = new Product("Pencil", 2, 10.00F, false, new Date());
			Product product3 = new Product("Satchel", 1, 100.30F, false, new Date());
